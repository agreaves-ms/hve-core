...
* Use source-relative `#file:` directives for packaged instruction targets, stable artifact or skill names for host discovery, and skill-root-relative paths for resources inside a skill.
